    ...
    <div class="login-form">
        <form action="" method="post">
            ...
            <div class="form-group">
                ...
                <input id="pseudo" type="text" name="pseudo" class="form-control" placeholder="Pseudo"
                    required="required" />
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input id="dateNaissance" type="date" name="dateNaissance" class="form-control"
                    placeholder="Date Naissance" required="required" />
            </div>
            <div class="form-group">
                <label for="adresse">Adresse</label>
                <input id="adresse" type="text" name="adresse" class="form-control" placeholder="Adresse postale"
                    required="required" />
            </div>
            <div class="form-group">
                <label for="cp">Code postal</label>
                <input id="cp" type="text" name="cp" pattern="[0-9]*" class="form-control" placeholder="Code postal"
                    required="required" />
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input id="confimPass" type="password" name="pass-conf" class="form-control"
                    placeholder="Confirmer le mot de passe" required="required" />
            </div>
            <div class="form-group">
