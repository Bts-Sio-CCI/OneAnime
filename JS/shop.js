...
function removeFromCart(id) {
    ...
    if (existingItem) {
        ...
        const priceDifference = existingItem.price * 0.5;
...
function updateCartDisplay() {
    ...
    if (panierElement) {
        ...
        cart.forEach((item) => {
            ...
            cartItem.innerHTML = `
                ...
                <div class="cart-item-description">
                    <p>${item.description || ""} ${itemCountText}</p>
                </div>
        ...
        // Mettez à jour le prix total une seule fois après avoir parcouru tous les éléments du panier
        panierElement.innerHTML += `<p>Total : ${prix_Total.toFixed(2)} €</p>`;
    } else {
